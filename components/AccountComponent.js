        ...
        <View style={[styles.item]}>
          <View style={styles.context}>
            <View style={styles.user}>
              <Image style={[styles.avatar, styles.styleAvatar]} source={{ uri: 'https://yt3.ggpht.com/a/AGF-l7-ZgNkj_kuKtcbpHTRcz4BFBJSw0AC1imWcQQ=s900-c-k-c0xffffffff-no-rj-mo' }} />
